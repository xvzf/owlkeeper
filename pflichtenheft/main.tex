...
\documentclass[
	...
	a4paper,%             A4 Papier
	oneside,%             Einseitig
	bibtotoc,%    			Literaturverzeichnis einfï¿½gen bibtotocnumbered: nummeriert
	liststotoc,%			Verzeichnisse einbinden in toc
	halfparskip,%        Europï¿½ischer Satz mit abstand zwischen Absï¿½tzen
	chapterprefix,%       Kapitel anschreiben als Kapitel
	headsepline,%         Linie nach Kopfzeile
	12pt%                 Grï¿½ssere Schrift, besser lesbar am bildschrim
]{scrartcl}
...
\include{content/1-Zielbestimmungen}
\include{content/2-Produkteinsatz}
\include{content/3-Produktumgebung}
